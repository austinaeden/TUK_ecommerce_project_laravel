                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        <div class="logo logo-width-1 wow fadeIn animated">
                            <a href="/"><img src="user/assets/imgs/logo/img_logo.jpg" alt="logo"></a>
                        </div>
                        <h5 class="mt-20 mb-10 fw-600 text-grey-4 wow fadeIn animated">Contact</h5>
                        <p class="wow fadeIn animated">
                            <strong>Address: </strong>Haile Selassie Avenue Nairobi, Opposite Times Tower, near City Square Post Office, P.O. Box 52428 – 00200, Nairobi
                        </p>
                        <p class="wow fadeIn animated">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <p class="text-lg-end text-start font-sm text-muted mb-0">
                    &copy; <strong class="text-brand">UrbanContemporary</strong> All rights reserved
                </p>
            </div>
        </div>
    </div>
